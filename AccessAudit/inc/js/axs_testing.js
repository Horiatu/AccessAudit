...
var fn = (function() {
    ...
    axs.color.calculateContrastRatio = function(a, b) {
        ...
        var c = axs.color.calculateLuminance(a),
            d = axs.color.calculateLuminance(b);
    ...
    axs.color.suggestColors = function(a, b, c) {
        var d = {},
            e = axs.color.calculateLuminance(a),
            f = axs.color.calculateLuminance(b),
            g = f > e,
            h = axs.color.toYCbCr(b),
            k = axs.color.toYCbCr(a),
            m;
        for (m in c) {
            var l = c[m],
                n = axs.color.luminanceFromContrastRatio(e, l + .02, g);
            if (1 >= n && 0 <= n) {
                var p = axs.color.translateColor(h, n),
    ...
    axs.color.findIntersection = function(a, b) {
        var c = [a.a.x - b.p0.x, a.a.y - b.p0.y, a.a.z - b.p0.z],
            d = axs.color.invert3x3Matrix([
                [a.a.x - a.b.x, b.p1.x - b.p0.x, b.p2.x - b.p0.x],
                [a.a.y - a.b.y, b.p1.y - b.p0.y, b.p2.y - b.p0.y],
                [a.a.z - a.b.z, b.p1.z - b.p0.z, b.p2.z - b.p0.z]
            ]),
            c = axs.color.multiplyMatrixVector(d, c)[0];
    ...
    axs.utils.getHtmlIdReferrers = function(a) {
        ...
        var b = b.replace(/'/g, "\\'"),
            c = "[contextmenu='{id}'] [itemref~='{id}'] button[form='{id}'] button[menu='{id}'] fieldset[form='{id}'] input[form='{id}'] input[list='{id}'] keygen[form='{id}'] label[for='{id}'] label[form='{id}'] menuitem[command='{id}'] object[form='{id}'] output[for~='{id}'] output[form='{id}'] select[form='{id}'] td[headers~='{id}'] textarea[form='{id}'] tr[headers~='{id}']".split(" ").map(function(a) {
    ...
    axs.utils.getIdReferrers = function(a) {
        var b = [],
            c = axs.utils.getHtmlIdReferrers(a);
    ...
    axs.properties.getFocusProperties = function(a) {
        ...
        void 0 != c ? b.tabindex = {
            value: c,
            valid: !0
        } : axs.utils.isElementImplicitlyFocusable(a) && (b.implicitlyFocusable = {
            value: !0,
            valid: !0
        });
    ...
    axs.properties.hasDirectTextDescendant = function(a) {
        ...
        return c.evaluate ? b() : function() {
            for (var b = c.createTreeWalker(a, NodeFilter.SHOW_TEXT, null, !1); b.nextNode();) {
                var e = b.currentNode,
                    f = e.parentNode.tagName.toLowerCase();
    ...
    axs.properties.getContrastRatioProperties = function(a) {
        ...
        var f = axs.utils.isLargeFont(c) ? 3 : 4.5,
            c = axs.utils.isLargeFont(c) ? 4.5 : 7,
            g = {};
        f > a && (g.AA = f);
        c > a && (g.AAA = c);
    ...
    axs.properties.findTextAlternatives = function(a, b, c, d) {
        ...
        if (a.nodeType == Node.TEXT_NODE) {
            return c = {
                type: "text"
            }, c.text = a.textContent, c.lastWord = axs.properties.getLastWord(c.text), b.content = c, a.textContent;
        }
        a = null;
        ...
        (d = axs.properties.getTextFromDescendantContent(c, d)) && f && (e = {
            type: "text"
        }, e.text = d, e.lastWord = axs.properties.getLastWord(e.text), a ? e.unused = !0 : a = d, b.content = e);
    ...
    axs.properties.getTrackElements = function(a, b) {
        ...
        for (var e = [], f = 0; f < c.length; f++) {
            ...
            h ? (g.valid = !0, g.src = h) : (g.valid = !1, g.reason = {
                messageKey: "noSrcProvided"
            });
            h = "";
            m && (h += m, k && (h += " "));
            k && (h += "(" + k + ")");
    ...
    axs.AuditRule.collectMatchingElements = function(a, b, c, d) {
        axs.dom.composedTreeSearch(a, null, {
            preorder: function(a) {
                if (d) {
    ...
    axs.AuditRules.addRule({
        ...
        severity: axs.constants.Severity.SEVERE,
        relevantElementMatcher: function(a) {
            var b = axs.utils.getAriaPropertiesByValueType(["idref", "idref_list"]),
                b = axs.utils.getSelectorForAriaProperties(b);
            return axs.browserUtils.matchSelector(a, b);
        },
        test: function(a) {
    ...
    (function() {
        axs.AuditRules.addRule({
            name: "tableHasNoAppropriateHeaders",
    ...
    (function() {
        var a = /^aria\-/,
            b = axs.utils.getSelectorForAriaProperties(axs.constants.ARIA_PROPERTIES);
        axs.AuditRules.addRule({
            ...
            test: function(b) {
                var d = axs.utils.getRoles(b, !0),
                    d = d && d.applied ? d.applied.details.propertiesSet : axs.constants.GLOBAL_PROPERTIES;
                b = b.attributes;
